...
//cartridge map with file id for each frame.
int16_t CartridgeMap[CART_MAX_CARTRIDGES][CART_CARTRIDGE_SIZE];
//int NewFrameMap[CART_MAX_CARTRIDGES][CART_CARTRIDGE_SIZE];
